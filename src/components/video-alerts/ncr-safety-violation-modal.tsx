            ...
            <div className="grid grid-cols-12 border-b border-black">
              ...
              <div className="col-span-11">
                ...
                <div className="grid grid-cols-5 border-b border-black text-sm">
                  ...
                  <div className="border-r border-black p-2 bg-yellow-200">Taking an unsafe position</div>
                  <div className="border-r border-black p-2">Improper attitude or motivation</div>
                ...
                <div className="grid grid-cols-5 border-b border-black text-sm">
                  ...
                  <div className="border-r border-black p-2">Lack of knowledge or skill</div>
