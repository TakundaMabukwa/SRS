...
export default function NCRSafetyViolationModal({ isOpen, onClose, driverInfo, alertDetails }: SafetyViolationModalProps) {
  ...
  const [section, setSection] = useState('Safety / Compliance')
  const [description, setDescription] = useState(
    `The driver of fleet ${driverInfo.fleetNumber} was found in violation of fleet safety rules based on in-cab camera analytics. Behaviour observed includes distracted driving and non-compliance with seatbelt/cellphone policies.`
  )
  const [correctiveAction, setCorrectiveAction] = useState('.')
  const [preventiveAction, setPreventiveAction] = useState('')
  const [investigator, setInvestigator] = useState('')
  const [manager, setManager] = useState('Rowan / Diego')
  const [selectedRootCauses, setSelectedRootCauses] = useState<string[]>([])
  const rootCauseStorageKey = useMemo(
    () => `ncr-safety-root-causes:${alertDetails?.id || driverInfo.fleetNumber || 'unknown'}`,
    [alertDetails?.id, driverInfo.fleetNumber]
  )
  const rootCauseDefaults = useMemo(
    () => ['taking_an_unsafe_position', 'ignoring_she_regulations', 'ignoring_road_traffic_act'],
    []
  )
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const { error: dbError } = await supabase.from('reports').insert({
        ...
        priority: 'High',
        report_type: 'NCR_SAFETY_VIOLATION',
    ...
    <div className="fixed inset-0 z-50 bg-black/50 p-4 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-2xl w-[95vw] h-[90vh] flex flex-col">
        <div className="flex items-center justify-between p-4 border-b">
          <h2 className="text-xl font-bold">ncr-safety-violation</h2>
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-slate-100">
          <div id="ncr-safety-violation-content" className="mx-auto max-w-[1080px] bg-white border-2 border-black text-black">
            <div className="border-b-2 border-black grid grid-cols-12 text-sm">
              ...
              <div className="col-span-3 text-xs">
                <div className="grid grid-cols-2 border-b border-black"><div className="p-2 border-r border-black bg-slate-100">Document Number</div><div className="p-2 font-bold">Non - Conformance Report / 001</div></div>
                <div className="grid grid-cols-2 border-b border-black"><div className="p-2 border-r border-black bg-slate-100">Revision Number / Date</div><div className="p-2 font-bold">00 / 18th June 2027</div></div>
            ...
            <div className="grid grid-cols-12 border-b border-black">
              ...
              <div className="col-span-11">
                ...
                <div className="grid grid-cols-8 border-b border-black text-sm">
                  ...
                  <div className="col-span-2 p-2">00h00 to 23h00</div>
                </div>
                <div className="grid grid-cols-8 border-b border-black text-sm">
                  ...
                  <div className="col-span-3 p-2">Multiple</div>
                </div>
                ...
                <div className="grid grid-cols-6 border-b border-black text-sm">
                  ...
                  <div className="border-r border-black p-2">Insubordination</div>
                  ...
                  <div className="p-2 bg-yellow-200">No Seatbelt</div>
                </div>
                <div className="grid grid-cols-6 border-b border-black text-sm">
                  <div className="border-r border-black p-2">Reckless Driving</div>
                ...
                <div className="grid grid-cols-6 border-b border-black text-sm">
                  ...
                  <div className="col-span-4 p-2">Other: Cellphone usage and not wearing seatbelt</div>
                </div>
            ...
            <div className="grid grid-cols-12 border-b border-black">
              ...
              <div className="col-span-11">
                ...
                <div className="grid grid-cols-5 border-b border-black text-sm">
                  <div className={getRootCauseCellClass('distracting_horseplay')} onClick={() => toggleRootCause('distracting_horseplay')}>Distracting/horseplay</div>
                ...
                <div className="grid grid-cols-12 border-b border-black text-sm">
                  ...
                  <div className="col-span-2 p-2">Low Risk <span className="text-red-600 font-bold">X</span></div>
                </div>
            ...
            <div className="p-3 text-sm border-b border-black">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="border border-black">
                  ...
                  <div className="p-1 bg-yellow-200 text-red-600 font-semibold">C Moderate - Isolated incidents</div>
                  <div className="p-1">D Low</div>
                  <div className="p-1">E Very Low</div>
                </div>
                <div className="border border-black">
                  <div className="border-b border-black p-1 font-bold">Severity / Consequence</div>
                  <div className="p-1">3 - Very Serious (Highlighted)</div>
                </div>
              </div>
            </div>

            <div className="p-3 text-sm border-b border-black">
              <div className="font-bold text-lg mb-2">Annexture A (Picture Evidence)</div>
